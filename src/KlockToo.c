...
void draw_grid() {
  ...
  text_layer_set_text_color(it_text_layer, BACKGROUND);
  text_layer_set_background_color(it_text_layer, FOREGROUND);
  ...
  text_layer_set_text_color(random_text_layer, FOREGROUND);
  text_layer_set_background_color(random_text_layer, BACKGROUND);
  ...
  text_layer_set_text_color(is_text_layer, BACKGROUND);
  text_layer_set_background_color(is_text_layer, FOREGROUND);
  ...
  text_layer_set_text_color(am_text_layer, FOREGROUND);
  text_layer_set_background_color(am_text_layer, BACKGROUND);
  ...
  text_layer_set_text_color(pm_text_layer, FOREGROUND);
  text_layer_set_background_color(pm_text_layer, BACKGROUND);
  ...
  text_layer_set_text_color(a_text_layer, FOREGROUND);
  text_layer_set_background_color(a_text_layer, BACKGROUND);
  ...
  text_layer_set_background_color(quarter_text_layer, BACKGROUND);
  ...
  text_layer_set_text_color(twenty_text_layer, FOREGROUND);
  text_layer_set_background_color(twenty_text_layer, BACKGROUND);
  ...
  text_layer_set_background_color(mfive_text_layer, BACKGROUND);
  ...
  text_layer_set_background_color(half_text_layer, BACKGROUND);
  ...
  text_layer_set_text_color(mten_text_layer, FOREGROUND);
  text_layer_set_background_color(mten_text_layer, BACKGROUND);
  ...
  text_layer_set_text_color(to_text_layer, FOREGROUND);
  text_layer_set_background_color(to_text_layer, BACKGROUND);
  ...
  text_layer_set_background_color(past_text_layer, BACKGROUND);
  ...
  text_layer_set_background_color(hnine_text_layer, BACKGROUND);
  ...
  text_layer_set_text_color(hone_text_layer, FOREGROUND);
  text_layer_set_background_color(hone_text_layer, BACKGROUND);
  ...
  text_layer_set_text_color(hsix_text_layer, FOREGROUND);
  text_layer_set_background_color(hsix_text_layer, BACKGROUND);
  ...
  text_layer_set_background_color(hthree_text_layer, BACKGROUND);
  ...
  text_layer_set_background_color(hfour_text_layer, BACKGROUND);
  ...
  text_layer_set_background_color(hfive_text_layer, BACKGROUND);
  ...
  text_layer_set_text_color(htwo_text_layer, FOREGROUND);
  text_layer_set_background_color(htwo_text_layer, BACKGROUND);
  ...
  text_layer_set_background_color(height_text_layer, BACKGROUND);
  ...
  text_layer_set_background_color(heleven_text_layer, BACKGROUND);
  ...
  text_layer_set_background_color(hseven_text_layer, BACKGROUND);
  ...
  text_layer_set_background_color(htwelve_text_layer, BACKGROUND);
  ...
  text_layer_set_text_color(hten_text_layer, FOREGROUND);
  text_layer_set_background_color(hten_text_layer, BACKGROUND);
  ...
  text_layer_set_text_color(oclock_text_layer, FOREGROUND);
  text_layer_set_background_color(oclock_text_layer, BACKGROUND);
...
void draw_branding() {
  ...
  text_layer_set_text_color(brand_text, FOREGROUND);
  text_layer_set_background_color(brand_text, BACKGROUND);
...
static void set_ampm(struct tm* t) {
  ...
  if (hour >= 00 && hour <= 11) {
      text_layer_set_text_color(am_text_layer, BACKGROUND);
      text_layer_set_background_color(am_text_layer, FOREGROUND);
      text_layer_set_text_color(pm_text_layer, FOREGROUND);
      text_layer_set_background_color(pm_text_layer, BACKGROUND);
  } else if (hour >= 12 && hour <= 23) {
      text_layer_set_text_color(pm_text_layer, BACKGROUND);
      text_layer_set_background_color(pm_text_layer, FOREGROUND);
      text_layer_set_text_color(am_text_layer, FOREGROUND);
      text_layer_set_background_color(am_text_layer, BACKGROUND);
  }
}
...
static void hour2text(struct tm* t) {
  ...
  if (hour == 1) {
    text_layer_set_text_color(hone_text_layer, BACKGROUND);
    text_layer_set_background_color(hone_text_layer, FOREGROUND);
  } else if (hour == 2) {
    text_layer_set_text_color(htwo_text_layer, BACKGROUND);
    text_layer_set_background_color(htwo_text_layer, FOREGROUND);
  } else if (hour == 3) {
    text_layer_set_text_color(hthree_text_layer, BACKGROUND);
    text_layer_set_background_color(hthree_text_layer, FOREGROUND);
  } else if (hour == 4) {
    text_layer_set_text_color(hfour_text_layer, BACKGROUND);
    text_layer_set_background_color(hfour_text_layer, FOREGROUND);
  } else if (hour == 5) {
    text_layer_set_text_color(hfive_text_layer, BACKGROUND);
    text_layer_set_background_color(hfive_text_layer, FOREGROUND);
  } else if (hour == 6) {
    text_layer_set_text_color(hsix_text_layer, BACKGROUND);
    text_layer_set_background_color(hsix_text_layer, FOREGROUND);
  } else if (hour == 7) {
    text_layer_set_text_color(hseven_text_layer, BACKGROUND);
    text_layer_set_background_color(hseven_text_layer, FOREGROUND);
  } else if (hour == 8) {
    text_layer_set_text_color(height_text_layer, BACKGROUND);
    text_layer_set_background_color(height_text_layer, FOREGROUND);
  } else if (hour == 9) {
    text_layer_set_text_color(hnine_text_layer, BACKGROUND);
    text_layer_set_background_color(hnine_text_layer, FOREGROUND);
  } else if (hour == 10) {
    text_layer_set_text_color(hten_text_layer, BACKGROUND);
    text_layer_set_background_color(hten_text_layer, FOREGROUND);
  } else if (hour == 11) {
    text_layer_set_text_color(heleven_text_layer, BACKGROUND);
    text_layer_set_background_color(heleven_text_layer, FOREGROUND);
  } else {
    text_layer_set_text_color(htwelve_text_layer, BACKGROUND);
    text_layer_set_background_color(htwelve_text_layer, FOREGROUND);
    set_ampm(t);
  }
}
...
static void minute2text(struct tm* t) {
  ...
  if (started == 0 || lastmin == 0 || lastmin == 5) {
    ...
    if (minute >= 0 && minute <= 4) {
      text_layer_set_text_color(oclock_text_layer, BACKGROUND);
      text_layer_set_background_color(oclock_text_layer, FOREGROUND);
    } else if (minute >= 5 && minute <= 9) {
      text_layer_set_text_color(mfive_text_layer, BACKGROUND);
      text_layer_set_background_color(mfive_text_layer, FOREGROUND);
    } else if (minute >= 10 && minute <= 14) {
      text_layer_set_text_color(mten_text_layer, BACKGROUND);
      text_layer_set_background_color(mten_text_layer, FOREGROUND);
    } else if (minute >= 15 && minute <= 19) {
      text_layer_set_text_color(a_text_layer, BACKGROUND);
      text_layer_set_background_color(a_text_layer, FOREGROUND);
      text_layer_set_text_color(quarter_text_layer, BACKGROUND);
      text_layer_set_background_color(quarter_text_layer, FOREGROUND);
    } else if (minute >= 20 && minute <= 24) {
      text_layer_set_text_color(twenty_text_layer, BACKGROUND);
      text_layer_set_background_color(twenty_text_layer, FOREGROUND);
      ...
      text_layer_set_text_color(half_text_layer, BACKGROUND);
      text_layer_set_background_color(half_text_layer, FOREGROUND);
    ...
    if (minute >= 5 && minute <= 34) { // handle tense
      text_layer_set_text_color(past_text_layer, BACKGROUND);
      text_layer_set_background_color(past_text_layer, FOREGROUND);
      text_layer_set_text_color(to_text_layer, FOREGROUND);
      text_layer_set_background_color(to_text_layer, BACKGROUND);
    } if (minute >= 35) {
      text_layer_set_text_color(to_text_layer, BACKGROUND);
      text_layer_set_background_color(to_text_layer, FOREGROUND);
      text_layer_set_text_color(past_text_layer, FOREGROUND);
      text_layer_set_background_color(past_text_layer, BACKGROUND);
    } else if(minute < 5) {
      text_layer_set_text_color(to_text_layer, FOREGROUND);
